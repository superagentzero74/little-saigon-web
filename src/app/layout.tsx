...
export const metadata: Metadata = {
  title: {
    default: "Little Saigon — Vietnamese Business & Community Guide | Westminster, Garden Grove, Fountain Valley",
  ...
  keywords: [
    ...
    "Fountain Valley", "Orange County", "pho", "banh mi", "Vietnamese food",
    "Vietnamese nail salon", "Vietnamese services",
  ],
  openGraph: {
    title: "Little Saigon — Vietnamese Business & Community Guide",
    description: "420+ Vietnamese restaurants, bakeries, services, and businesses in Westminster, Garden Grove & Fountain Valley.",
    locale: "en_US",
    type: "website",
